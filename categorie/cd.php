...
<header>
    ...
    <?php endif; ?>
                ...
                <li><a href="titres_periodiques.php">Titres Periodiques</a></li>
            </ul>
    ...
    <main>
        ...
        <?php if ($isAbonne): ?>
            <?php if ($row['statut'] === 'disponible' && !$hasLateEmprunt && $nbEmpruntsActifs < 4): ?>
                <a class="voir-details" href="confirmation_emprunt_cd.php?id_livre=<?php echo $row['id']; ?>">Voir les détails</a>
