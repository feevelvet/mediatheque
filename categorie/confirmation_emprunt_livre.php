...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && empty($message_erreur)) {
    ...
    if (mysqli_num_rows($result_precommande) > 0) {
        ...
        VALUES ('$id_livre', '$id_abonne', '$email', '$date_emprunt', '$date_retour', 'livre')
        ";
...
<body>
    ...
    <a href="livre.php"><button>Retourner voir les livres</button></a>


    <!-- Ajouter des boutons pour les deux autres types -->
        <!-- Si on est sur un livre, ajouter des liens pour les films et les CDs -->
    ...
    <form action="confirmation_emprunt_livre.php?id_livre=<?php echo $livre['id']; ?>" method="post">
